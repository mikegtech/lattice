 ...
 */
export type SectionType = 'header' | 'greeting' | 'body' | 'signature' | 'quote' | 'attachment_text';
 ...
 */
export type DeletionReason = 'user_request' | 'retention_policy' | 'reprocess' | 'gdpr_request' | 'admin_action';
