...
export class EmailRepository {
  ...
  async upsertAttachments(emailId: string, attachments: AttachmentRecord[]): Promise<void> {
    ...
    try {
      ...
      await client.query('DELETE FROM email_attachment WHERE email_id = $1', [emailId]);
