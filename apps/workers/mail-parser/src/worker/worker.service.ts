...
export class MailParserService extends BaseWorkerService<MailRawPayload, MailParsePayload> {
  ...
  > {
    ...
    this.logger.info('Processing raw email', logContext);
    ...
    try {
      ...
      const emailRecord: EmailRecord = {
        ...
        parsed_at: new Date(),
        raw_object_uri: payload.raw_object_uri,
        size_bytes: payload.size_bytes,
        text_body: parsedPayload.body.text_plain,
        html_body: parsedPayload.body.text_html,
        text_normalized: parsedPayload.body.text_normalized,
      };
