...
async function generateWorker(name: string): Promise<void> {
	...
	console.log(
		"  4. Implement processing logic in src/worker/worker.service.ts",
	);
...
if (args.length === 0 || args[0] === "--help" || args[0] === "-h") {
	...
	console.log(
		"  worker-name  Name of the worker (kebab-case, e.g., email-embedder)",
	);
	console.log("");
	console.log("Example:");
...
// Validate name
if (
	!/^[a-z][a-z0-9-]*[a-z0-9]$/.test(workerName) ||
	workerName.includes("--")
) {
